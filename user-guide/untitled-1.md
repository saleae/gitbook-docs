...
_**Before operating your Saleae Logic product for the first time, please carefully review the safety guidelines below to avoid any injury and damage.**_
...
Saleae products are covered by a 3-year warranty, regardless of where you purchased the product. For more information, see: [https://trello.com/c/FY4U279I](https://trello.com/c/FY4U279I)

If you believe your Logic hardware is broken, please follow the troubleshooting steps in the article here: [https://trello.com/c/YYFxchY7](https://trello.com/c/YYFxchY7). Afterwards, if the device continues to fail, [write a message to us](https://support.saleae.com/hc/en-us/requests/new) with the detailed results of the troubleshooting steps, as well as any relevant information that is requested in that article.
