...
<p>The information provided in this article applies to the latest production software downloadable <a href="https://www.saleae.com/downloads/">here</a>. The software collects some additional usage data that are not mentioned in this article, though captured data is never shared with us. The user can opt-out of providing such usage data via the Options menu.</p>
</div>
...
<a class="content-ref" href="/support/specifications-hardware/electrical-characteristics/device-calibration">Device Calibration</a>
