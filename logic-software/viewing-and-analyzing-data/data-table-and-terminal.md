...
![Data Table options via 3 dots](/support-assets/Screen%20Shot%202021-07-14%20at%205.36.33%20PM.png)
...
!["Show/Hide Columns" Window via Right Clicking the Data Table Header](/support-assets/Screen%20Shot%202021-07-14%20at%205.47.26%20PM.png)
...
<figure><img src="/support-assets/Screen%20Shot%202023-01-26%20at%203.18.47%20PM.png" alt=""><figcaption><p>Jumping to a Waveform Bubble from the Data Table</p></figcaption></figure>
...
![Jumping to a Row in the Data Table](/support-assets/Screen%20Shot%202021-04-07%20at%203.40.30%20PM.png)
...
#### Columns May Not Always Appear in the Same Order

This happens rarely, and is a known issue at the moment. The root problem is that the columns appear in the order that the fields are first seen, which can vary depending on the data in the capture. This can be a pain point for post-processing exports in particular.
...
![Terminal View showing I2C data](/support-assets/Screen%20Shot%202021-07-14%20at%205.53.44%20PM.png)
...
![I2C Terminal View Example](/support-assets/Screen%20Shot%202021-09-10%20at%205.20.12%20PM.png)

* **SPI** - will display in hex in the format `MOSI / MISO` .

![SPI Terminal View Example](/support-assets/Screen%20Shot%202021-09-10%20at%205.23.44%20PM.png)
...
<figure><img src="/support-assets/Screen%20Shot%202023-01-17%20at%206.10.56%20PM.png" alt=""><figcaption><p>Carriage Return to Line Feed Converter Extension</p></figcaption></figure>
