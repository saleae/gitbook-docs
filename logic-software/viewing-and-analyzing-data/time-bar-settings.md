...
![](/support-assets/Screen%20Shot%202021-04-02%20at%202.32.18%20PM.png)
...
<p>The Wall Clock Time format setting will only show up when you pan the capture all the way to the left (i.e. at the beginning of the capture). When you are zoomed in anywhere else in the capture, the wall clock time will not appear.</p>
<p>We certainly need to improve the way this feature works in such a way to avoid this confusion. If you have any issues with the way it’s implemented now, feel free to vote for improvements <a href="https://ideas.saleae.com">here</a>!</p>
</div>

![Scroll to the beginning of capture to see Wall Clock Time](/support-assets/Screen%20Shot%202021-04-21%20at%205.14.57%20PM.png)

### Time Preferences

The Time Preferences may also be opened for further customization on the time bar behavior.

![Time Preferences Window](/support-assets/Screen%20Shot%202021-04-02%20at%202.41.25%20PM.png)
