...
![Fritzing diagram showing how to connect the Saleae logic analyzer to the Nucleo board](../.gitbook/assets/uart_circuit_fritzing.png)
...
![Testing the serial echo program](http://localhost:4000/assets/images/getting-started/screen_15.png?style=center)
...
![Setting up to capture UART signals with Logic](http://localhost:4000/assets/images/getting-started/screen_16.png?style=center)
...
![Select falling edge option for triggering with the Saleae Logic Analyzer](http://localhost:4000/assets/images/getting-started/screen_17.png?style=center)
...
![Captured UART data](http://localhost:4000/assets/images/getting-started/screen_18.png?style=center)
...
![Configure the analyzer settings](http://localhost:4000/assets/images/getting-started/screen_19.png?style=center)
...
![Analyzing captured serial data with the Logic software](http://localhost:4000/assets/images/getting-started/screen_20.png?style=center)
