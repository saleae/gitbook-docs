...
![Plugging second cable harness into the Saleae Logic Analyzer](http://localhost:4000/assets/images/getting-started/saleae_harness_2.jpg?style=center)
...
![Fritzing diagram showing how to connect the Saleae logic analyzer to the Nucleo board](../.gitbook/assets/digital_circuit_fritzing.png)
...
![Configuring Logic Analyzer to measure digital signals](http://localhost:4000/assets/images/getting-started/screen_06.png?style=center)
...
![Capturing digital signals with the Saleae Logic Analyzer](http://localhost:4000/assets/images/getting-started/screen_07.png?style=center)
...
![Measuring pulse width, frequency, and period with Saleae Logic](http://localhost:4000/assets/images/getting-started/screen_08.png?style=center)
...
![Disable triggers in the Logic software](http://localhost:4000/assets/images/getting-started/screen_09.png?style=center)

Click on the **Trigger Settings Button** for Channel 7. Select the **Trigger on Falling Edge** button.

![Enable triggering on falling edge in the Saleae Logic software](http://localhost:4000/assets/images/getting-started/screen_10.png?style=center)
...
![Viewing a waveform that has been captured around a trigger](http://localhost:4000/assets/images/getting-started/screen_11.png?style=center)
