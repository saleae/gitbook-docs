...
* [Async Serial](/support/extensions-api/hla-frame-format-reference/serial-analyzer)
* [I2C](/support/extensions-api/hla-frame-format-reference/i2c-analyzer)
* [SPI](/support/extensions-api/hla-frame-format-reference/spi-analyzer)
* [CAN](/support/extensions-api/hla-frame-format-reference/can-analyzer)
* [LIN](/support/extensions-api/hla-frame-format-reference/lin-analyzer)
* [Manchester](/support/extensions-api/hla-frame-format-reference/manchester-analyzer)
* [Parallel](/support/extensions-api/hla-frame-format-reference/simple-parallel-analyzer)
* [LED](/support/extensions-api/hla-frame-format-reference/async-rgb-led-analyzer)
* [1-Wire](/support/extensions-api/hla-frame-format-reference/1-wire-analyzer)
* [I2S / PCM](/support/extensions-api/hla-frame-format-reference/i2s-analyzer)
