...
#### Connect Hardware <a href="#connect-hardware-2" id="connect-hardware-2"></a>
...
![](/support-assets/uart_circuit_fritzing%20(1)%20(1).png)

#### Run Demo Application <a href="#run-demo-application-2" id="run-demo-application-2"></a>

Download the example code for your IDE:

<a href="/support-assets/uart_example_arduino.zip" download class="content-ref">UART Example - Arduino</a>

<a href="/support-assets/uart_example_mbed.zip" download class="content-ref">UART Example - mbed</a>

<a href="/support-assets/uart_example_sw4stm32.zip" download class="content-ref">UART Example - SW4STM32</a>
...
![](/support-assets/screen_15.png)

#### Measure the Signal <a href="#measure-the-signal-1" id="measure-the-signal-1"></a>
