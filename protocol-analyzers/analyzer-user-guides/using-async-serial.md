...
{% content-ref url="../supported-protocols/recording-multiple-protocols.md" %}
[recording-multiple-protocols.md](../supported-protocols/recording-multiple-protocols.md)
{% endcontent-ref %}
